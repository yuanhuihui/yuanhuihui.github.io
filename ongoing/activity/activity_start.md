...
找到或创建新的ActivityTask对象，之后调用AS.startActivityLocked
...
到此，正式进入了Activity的onCreate, onStart, onResume这些生命周期的过程。后续计划再进一步讲解生命周期过程与系统是如何交互，敬请期待。

## 三. 总结

本文详细startActivity的整个启动流程，接下来用一副流程来描述整个过程：
