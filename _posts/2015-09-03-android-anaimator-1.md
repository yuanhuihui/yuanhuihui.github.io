...
- android:interpolator   插值器，用于指定动画的效果; 插值器原理，请移步[**Android动画之原理篇（三）**](http://yuanhuihui.github.io/2015/09/05/android-anaimator-3/)；
...
关于属性动画的详细介绍在下一篇文章中，详细介绍[**Android动画之入门篇（二）**](http://yuanhuihui.github.io/2015/09/04/android-anaimator-2/)