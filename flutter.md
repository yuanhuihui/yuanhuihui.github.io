...
这些疑问本文都逐一解读，如果仅仅是用Flutter做业务开发，并不需要掌握这么深度技术，不过，知其然知其所以然，能让你游刃有余。本文讲述跨平台技术的过去与未来，以及从宏观架构解读Flutter内部原理。
...
另外，创建了一个**微信群**，想加入Gityuan的Flutter交流群，可添加微信Gityuan，备注flutter即可。
...
后续将持续更深入的技术细节以及实战经验角度来跟大家揭秘更多Flutter技术，笔者仍在不断学习与梳理Flutter内部机制，当下写得较粗糙，后面再次整理，持续更新中。
